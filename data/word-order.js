...
export const CATEGORIES = {
  ...
  complex: {
    ...
    items: [
      ...
      { words: ["only", "when", "home", "I", "got", "did", "realize", "I", "my", "mistake"], correct: ["Only when I got home did I realize my mistake."], hint: "'Only when' + clause triggers inversion in the main clause", explain: "After a fronted 'only when' clause, the main clause inverts: did + subject + verb." },
      { words: ["rarely", "have", "I", "seen", "such", "dedication"], correct: ["Rarely have I seen such dedication."], hint: "Negative/limiting adverb at the front triggers inversion", explain: "'Rarely' fronted requires auxiliary before subject." },
    ],
  },
};
