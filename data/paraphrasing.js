...
export const CATEGORIES = {
  ...
  linkers: {
    ...
    items: [
      ...
      { source: "The weather was bad. We went anyway.", keyword: "EVEN THOUGH", correct: ["Even though the weather was bad, we went.", "Even though the weather was bad, we went anyway."], hint: "EVEN THOUGH + oración completa (a diferencia de DESPITE + gerundio)", explain: "'Even though' introduce una concesión con sujeto y verbo." },
  ...
  sentenceTransform: {
    ...
    items: [
      ...
      { source: "Someone stole my bike last night.", keyword: "HAD", correct: ["I had my bike stolen last night."], hint: "HAVE + objeto + participio = pasiva causativa", explain: "'Have something done' describe algo que le ocurre al sujeto, no algo que él hace." },
