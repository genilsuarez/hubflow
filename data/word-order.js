...
export const CATEGORIES = {
  statements: {
    ...
    items: [
      ...
      { words: ["better", "had", "you", "hurry"], correct: ["You had better hurry."], hint: "'Had better' = strong advice", explain: "'Had better' + base verb for urgent recommendations." },
  ...
  questions: {
    ...
    items: [
      ...
      { words: ["rather", "would", "tea", "or", "you", "coffee"], correct: ["Would you rather tea or coffee?"], hint: "'Would rather' + choice A + or + choice B", explain: "'Would rather' offers a preference between options." },
