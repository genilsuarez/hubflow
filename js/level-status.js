/* ═══════════════════════════════════════════════════════
   ...
   § "Comunicación cuando el nivel no avanza": si HubFlow ya cumplió su
   parte (≥50% del nivel activo) pero lp-level no subió porque otra app
   sigue por debajo de su umbral, se muestra un aviso con enlace a DeskFlow
   (el widget de nivel de DeskFlow es la vista de "estadísticas globales").
   ═══════════════════════════════════════════════════════ */
...
export function refreshLevelStatusBanner() {
  ...
  const hubflowDone = progress.hubflow.progressPct >= 50;
  ...
  const shouldShow = hubflowDone && !allDone;
