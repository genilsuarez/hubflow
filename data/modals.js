...
export const CATEGORIES = {
  meaning: {
    ...
    items: [
      ...
      { sentence: '___ you pass the salt, please?', correct: 'could', explain: '"Could" makes a polite request.' },
      { sentence: "It ___ be Sarah at the door — she said she'd come at 6.", correct: 'must', explain: '"Must" for a near-certain, logical deduction.' },
  ...
  obligation: {
    ...
    items: [
      ...
      { sentence: 'She ___ never lie to her clients — it\'s against her values.', correct: 'must', explain: '"Must" for a personal, internal obligation.' }
    ]
  },
  supposedTo: {
    ...
    items: [
      ...
      { sentence: "He ___ call me back, but he hasn't yet.", correct: 'was supposed to', explain: 'A past arrangement that hasn\'t happened as expected.' },
