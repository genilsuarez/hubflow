export const CATEGORIES = {
  portmanteauWords: {
    ...
    items: [
      ...
      { sentence: "The fog made driving dangerous. (smoke + fog)", correct: 'smog', explain: "'Smog' blends 'smoke' and 'fog'.", options: ['smog', 'smoke-fog', 'smofog'] },
      ...
      { sentence: "The device combines a phone and a camera. (picture + element)", correct: 'pixel', explain: "'Pixel' blends 'picture' and 'element'.", options: ['pixel', 'picel', 'pixelement'] },
      { sentence: "He gave a ___ talk about the merger. (webinar refers to web + seminar)", correct: 'webinar', explain: "'Webinar' blends 'web' and 'seminar'.", options: ['webinar', 'webseminar', 'webnar'] },
  ...
  compoundAdjectivesAdvanced: {
    ...
    items: [
      ...
      { sentence: "The negotiations reached a ___ agreement.", correct: 'mutually-beneficial', explain: "Adverb + adjective compounds are often hyphenated before a noun.", options: ['mutually-beneficial', 'mutuallybeneficial', 'mutually beneficial'] },
  ...
  prefixedNeologisms: {
    ...
    items: [
      ...
      { sentence: "The app offers ___ recommendations.", correct: 'personalized', explain: "'Personalized' uses the suffix '-ized' with the noun 'person'.", options: ['personalized', 'personified', 'personable'] },
