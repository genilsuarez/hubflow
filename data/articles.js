...
export const CATEGORIES = {
  ...
  context: {
    ...
    items: [
      ...
      { sentence: 'The officer handed him ___ form. ___ form was in French.', correct: 'a', explain: 'First mention, countable singular, consonant sound → "a form". Second mention → "the form".' },
