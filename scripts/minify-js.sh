...
#
# Los módulos ES (exercise-shell.js, sync-engine.js, progress-store.js, etc.)
# NO se tocan: minificarlos sin --bundle no ahorra mucho y renombrarlos
# rompería los import specifiers cruzados entre módulos.
#
# index.html, generate-exercise-heads.mjs (150 exercises/) y guides/*.html
# enlazan directamente los .min.js — el .js original se mantiene como fuente
# editable y versionada en git.
set -euo pipefail
cd "$(dirname "$0")/../js"
