export const CATEGORIES = {
  ...
  linking: {
    ...
    items: [
      { term: "Turn_off", es: "Apagar (linked)", esSpeak: "Apagar", meaning: "Consonant-vowel link: /tɜːnɒf/ sounds like 'tur-noff'", emoji: "💡", example: "Turn‿off the light → /tɜː.nɒf/" },
      { term: "An_apple", es: "Una manzana (linked)", esSpeak: "Una manzana", meaning: "N links to vowel: /ənæpəl/ sounds like 'a-napple'", emoji: "🍎", example: "An‿apple → /ə.næ.pəl/" },
      { term: "Go_away", es: "Vete (linked)", esSpeak: "Vete", meaning: "Vowel-vowel link adds /w/: 'go-waway'", emoji: "👋", example: "Go‿away → /ɡəʊ.wə.weɪ/" },
      { term: "She_is", es: "Ella es (linked)", esSpeak: "Ella es", meaning: "Vowel-vowel link adds /j/: 'she-yiz'", emoji: "👩", example: "She‿is → /ʃiː.jɪz/" },
      { term: "Last_night", es: "Anoche (elision)", esSpeak: "Anoche", meaning: "Elision: /t/ drops between consonants", emoji: "🌙", example: "Las(t) night → /lɑːs.naɪt/" },
      { term: "Hand_bag", es: "Bolso (elision)", esSpeak: "Bolso", meaning: "Elision: /d/ drops between consonants", emoji: "👜", example: "Han(d)bag → /hæn.bæɡ/" },
      { term: "Don't_be", es: "No seas (assimilation)", esSpeak: "No seas", meaning: "Assimilation: /t/ → /p/ before /b/", emoji: "🚫", example: "Don'(t) be → /dəʊm.biː/" },
      { term: "Far_away", es: "Lejos (intrusive r)", esSpeak: "Lejos", meaning: "Intrusive /r/ between vowels: 'far-raway'", emoji: "🌄", example: "Far‿away → /fɑː.rə.weɪ/" },
      { term: "Want_to_go", es: "Querer ir (linking)", esSpeak: "Querer ir", meaning: "Multiple links: 'wanto-go' → /wɒn.tə.ɡəʊ/", emoji: "🚶", example: "Want‿to‿go → /wɒn.tə.ɡəʊ/" },
      { term: "I_agree", es: "Estoy de acuerdo", meaning: "Vowel-vowel link adds /j/: 'I-yagree'", emoji: "🤝", example: "I‿agree → /aɪ.jə.ɡriː/" },
      { term: "Next_day", es: "Al día siguiente (elision)", esSpeak: "Al día siguiente", meaning: "Elision: /t/ drops between consonants", emoji: "📆", example: "Nex(t) day → /neks.deɪ/" },
      { term: "Try_it", es: "Pruébalo (linked)", esSpeak: "Pruébalo", meaning: "Consonant-vowel link: /traɪ ɪt/ sounds like 'try-yit'", emoji: "🧪", example: "Try‿it → /traɪ.jɪt/" },
      { term: "Not_at_all", es: "Para nada (linking)", esSpeak: "Para nada", meaning: "Multiple links: /nɒ.tə.tɔːl/", emoji: "🙅", example: "Not‿at‿all → /nɒ.tə.tɔːl/" },
    ]
  },
  assimilation: {
    label: "🔀 Assimilation",
