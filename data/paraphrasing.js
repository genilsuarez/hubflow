...
export const CATEGORIES = {
  grammarTransform: {
    ...
    items: [
      ...
      { source: "It's not necessary for you to come.", keyword: "HAVE", correct: ["You don't have to come."], hint: "not necessary = lack of obligation, not impossibility", explain: "'It's not necessary' = 'don't have to' (no obligation)." },
      { source: "She is too young to drive.", keyword: "ENOUGH", correct: ["She isn't old enough to drive.", "She is not old enough to drive."], hint: "use the opposite adjective + 'enough'", explain: "'Too + adj' can be rewritten as 'not + opposite adj + enough'." },
      ...
      { source: "Perhaps he missed the train.", keyword: "MIGHT", correct: ["He might have missed the train."], hint: "MIGHT + present perfect for a guess about a past event", explain: "'Perhaps + past simple' = 'might have + past participle'." },
      { source: "The last time I saw her was in 2019.", keyword: "SINCE", correct: ["I haven't seen her since 2019."], hint: "present perfect negative + SINCE + a point in time", explain: "'The last time' + past → present perfect negative + since." },
      { source: "We couldn't go out because of the storm.", keyword: "PREVENTED", correct: ["The storm prevented us from going out."], hint: "PREVENT + someone + FROM + verb-ing", explain: "'Prevent someone from doing' replaces 'couldn't because of'." },
      ...
      { source: "It's possible that she forgot.", keyword: "MAY", correct: ["She may have forgotten."], hint: "MAY + present perfect for a guess about a past event", explain: "'It's possible that X did' = 'X may have done'." },
      ...
      { source: "Nobody told me about the meeting.", keyword: "INFORMED", correct: ["I was not informed about the meeting.", "I wasn't informed about the meeting."], hint: "passive voice, negative form", explain: "'Nobody told me' → passive: 'I was not informed'." },
      { source: "Running is good for your health.", keyword: "DOES", correct: ["Running does you good.", "Running does good for your health."], hint: "fixed idiom: DOES + someone + an adjective meaning 'beneficial'", explain: "'Be good for' can be rewritten with 'does X good'." },
      { source: "I'm sure he didn't do it on purpose.", keyword: "CAN'T", correct: ["He can't have done it on purpose."], hint: "CAN'T + present perfect for strong certainty something didn't happen", explain: "'I'm sure not' → 'can't have + past participle' (strong deduction)." },
    ],
  },
  vocabTransform: {
    ...
    items: [
      ...
      { source: "He resembles his father.", keyword: "TAKES", correct: ["He takes after his father."], hint: "phrasal verb with TAKE describing family resemblance", explain: "'Resemble' = 'take after' (phrasal verb for family likeness)." },
      { source: "The project failed because of poor planning.", keyword: "DUE", correct: ["The project failed due to poor planning."], hint: "formal equivalent of 'because of'", explain: "'Due to' is a formal synonym for 'because of'." },
      { source: "She didn't expect to win.", keyword: "CAME", correct: ["The win came as a surprise to her.", "Winning came as a surprise to her."], hint: "fixed expression with CAME meaning 'was unexpected'", explain: "'Come as a surprise' = the opposite of expecting something." },
      { source: "He stopped smoking last year.", keyword: "GAVE", correct: ["He gave up smoking last year."], hint: "phrasal verb with GAVE meaning 'quit a habit'", explain: "'Give up' is the phrasal verb for 'stop' (a habit)." },
      { source: "I really admire her determination.", keyword: "UP", correct: ["I really look up to her determination."], hint: "phrasal verb meaning 'admire/respect' — starts with LOOK", explain: "'Look up to' = admire (someone or a quality)." },
      { source: "We need to reduce costs.", keyword: "CUT", correct: ["We need to cut down on costs.", "We need to cut costs."], hint: "phrasal verb with CUT meaning 'reduce gradually'", explain: "'Cut down on' = reduce (especially expenses/consumption)." },
      ...
      { source: "She considered all the options carefully.", keyword: "WEIGHED", correct: ["She weighed up all the options carefully."], hint: "phrasal verb with WEIGHED meaning 'evaluate carefully'", explain: "'Weigh up' = consider carefully before deciding." },
      { source: "The news spread quickly.", keyword: "GOT", correct: ["The news got around quickly.", "Word got around quickly."], hint: "phrasal verb with GOT meaning 'become known'", explain: "'Get around' = spread (of news, information)." },
      { source: "I'll investigate the problem.", keyword: "LOOK", correct: ["I'll look into the problem."], hint: "phrasal verb with LOOK meaning 'investigate'", explain: "'Look into' = investigate or examine." },
    ],
  },
  linkers: {
  ...
  sentenceTransform: {
    ...
    items: [
      ...
      { source: "I haven't eaten since breakfast.", keyword: "LAST", correct: ["The last time I ate was at breakfast.", "I last ate at breakfast."], hint: "LAST as an adverb of recency, or start with 'the last time...'", explain: "'Haven't done since X' = 'the last time was X'." },
      { source: "She is the fastest runner in the school.", keyword: "FASTER", correct: ["She runs faster than anyone else in the school.", "Nobody in the school runs faster than her."], hint: "superlative → comparative + 'than anyone/everyone else'", explain: "'The fastest' = 'faster than anyone else'." },
      { source: "I couldn't sleep because the music was so loud.", keyword: "KEPT", correct: ["The loud music kept me awake.", "The music kept me from sleeping."], hint: "causative pattern: KEEP + object + adjective (or + FROM + -ing)", explain: "'Keep + object + adj/from -ing' shows cause." },
      { source: "He insisted on paying for dinner.", keyword: "WOULDN'T", correct: ["He wouldn't let me pay for dinner.", "He wouldn't let anyone else pay for dinner."], hint: "WOULDN'T LET + object + base verb (refuse to allow)", explain: "'Insisted on doing' can become 'wouldn't let X do otherwise'." },
      { source: "You should have told me earlier.", keyword: "WHY", correct: ["Why didn't you tell me earlier?"], hint: "rhetorical question: WHY + didn't + subject + base verb", explain: "'You should have' often implies a reproachful 'why didn't you?'" },
    ],
  },
};
