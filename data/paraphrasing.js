...
export const CATEGORIES = {
  ...
  linkers: {
    ...
    items: [
      ...
      { source: "The weather was bad. We went anyway.", keyword: "EVEN THOUGH", correct: ["Even though the weather was bad, we went.", "Even though the weather was bad, we went anyway."], hint: "EVEN THOUGH + oración completa (a diferencia de DESPITE + gerundio)", explain: "'Even though' introduces a concession with a subject and a verb." },
  ...
  sentenceTransform: {
    ...
    items: [
      ...
      { source: "Someone stole my bike last night.", keyword: "HAD", correct: ["I had my bike stolen last night."], hint: "HAVE + objeto + participio = pasiva causativa", explain: "'Have something done' describes something that happens to the subject, not something they do." },
