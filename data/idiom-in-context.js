...
export const CATEGORIES = {
  everydayIdioms: {
    ...
    icon: '🗯️',
    options: ['piece of cake', 'break the ice', 'under the weather', 'cost an arm and a leg', 'once in a blue moon'],
    items: [
  ...
  businessFormalIdioms: {
    ...
    icon: '💼',
    options: ['think outside the box', 'get the ball rolling', 'on the same page', 'back to the drawing board', 'raise the bar'],
    items: [
